...
MesTestsUnitaires.prototype.testsGetSanction = function() {
    assertEquals('Moins de 0,8 g/l de sand', '6 points + suspension 3 ans', getSanction(0.4));
...
MesTestsUnitaires.prototype.testsGetString = function() {
    ...
    // Changement de sexe
    window.document.querySelector('#rd_sexehomme').removeAttribute('checked', 'checked');
...
TestExepedition = TestCase('Exepdition');

TestExepedition.prototype.testsGetFrais = function() {
